...
PROVIDERS_CATALOG = [
    ...
    },
    {
        ...
        "free":     False,
        "limits":   "Платный. От $0.15/1M токенов (gpt-4o-mini) и выше",
        "models":   "gpt-4o, gpt-4o-mini, gpt-4-turbo, o1-mini",
        "notes":    "Эталонное качество и tool-use, но платный",
    },
    {
        "name":     "SambaNova",
        "env_key":  "SAMBANOVA_API_KEY",
    ...
    {
        "name":     "zai (GLM)",   # совпадает с discovery-ключом "zai" для статуса
        "env_key":  "ZAI_API_KEY",
        "url":      "https://z.ai/",
        "signup":   "https://z.ai/",
        "free":     True,
    ...
    },
    {
        ...
        "free":     True,
        "limits":   "Бесплатно без карты, щедрый лимит",
        "models":   "100+ open-моделей: Llama 3.3-70b, Nemotron, и др.",
        "notes":    "Огромный выбор моделей одним ключом",
    },
    {
        "name":     "Cohere",
        "env_key":  "COHERE_API_KEY",
        ...
        "free":     True,
        "limits":   "Free trial-tier (rate-limited)",
        "models":   "Command-R, Command-R+ (OpenAI-совместимый /compatibility/v1)",
        "notes":    "Хорошо для RAG/инструментов",
    },
    {
        "name":     "Cloudflare AI",
        "env_key":  "CLOUDFLARE_API_TOKEN",
        ...
        "free":     True,
        "limits":   "Workers AI free tier (нужен account_id + cfat_ токен)",
        "models":   "Llama-3.1-8b, DeepSeek-R1-Distill-Qwen-32b",
        "notes":    "Нужен CLOUDFLARE_ACCOUNT_ID + токен с правами Workers AI",
    },
]
