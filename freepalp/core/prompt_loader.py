...
def get_worker_prompt(task_type: str) -> str:
    ...
    rules_suffix = (
        ...
        "- ЯЗЫК ОТВЕТА: всегда отвечай на языке запроса пользователя — это касается "
        "и обычных ответов, И отказов, И уточнений, И сообщений об ошибках "
        "(русский запрос → русский ответ; English query → English answer)\n"
